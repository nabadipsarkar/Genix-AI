...
const Login = () => {
  ...
  return (
    <form className="flex flex-col gap-4 m-auto items-start p-8 py-12 max-md:py-6 w-80 sm:w-[400px] text-gray-500 rounded-lg shadow-xl border border-gray-200 bg-slate-900">
